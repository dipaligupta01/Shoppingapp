...
public class DetailActivity extends AppCompatActivity {
    ...
    public ArrayList<Product> generateData() {
        ...
        product = new Product();
        product.setCatId(5);
        product.setpImage("lenovo k6 note.jpg");
        ...
        product = new Product();
        product.setCatId(5);
        product.setpImage("lenovok8.jpeg");
        ...
        product = new Product();
        product.setCatId(5);
        product.setpImage("lenovo z2 plus.jpg");
        ...
        product = new Product();
        product.setCatId(2);
        product.setpImage("galaxy j7 pro.jpg");
        ...
        product = new Product();
        product.setCatId(2);
        product.setpImage("galaxy on8.jpg");
        ...
        product = new Product();
        product.setCatId(2);
        product.setpImage("galaxy s8+.jpg");
        ...
        product = new Product();
        product.setCatId(2);
        product.setpImage("samsung-galaxy-j4.jpg");
        ...
        product = new Product();
        product.setCatId(1);
        product.setpImage("apple-iphone-x-new-1.jpg");
        ...
        product = new Product();
        product.setCatId(1);
        product.setpImage("iphone8 plus.jpg");
        ...
        product = new Product();
        product.setCatId(1);
        product.setpImage("iphone6s.jpg");
        ...
        product = new Product();
        product.setCatId(1);
        product.setpImage("iphone5s.jpg");
        ...
        product = new Product();
        product.setCatId(1);
        product.setpImage("iphone4s.jpg");
        ...
        product = new Product();
        product.setCatId(3);
        product.setpImage("nokia-8-sirocco-01.jpg");
        ...
        product = new Product();
        product.setCatId(3);
        product.setpImage("nokia-6-white1.jpg");
        ...
        product = new Product();
        product.setCatId(4);
        product.setpImage("redmi note5.png");
        ...
        product = new Product();
        product.setCatId(5);
        product.setpImage("lenovo p2.jpg");
        ...
        product = new Product();
        product.setCatId(5);
        product.setpImage("lenovo-k8-plus.jpg");
        ...
        product = new Product();
        product.setCatId(5);
        product.setpImage("lenovo k8 note.jpg");
